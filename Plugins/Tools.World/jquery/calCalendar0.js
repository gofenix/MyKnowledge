...
//国历节日 *表示放假日
	...
	*****************************************************************************/
	...
	function solarDay(objDate){
		...
		var sdate = '<font color="blue" style="font-size:9pt;">' + SY + '年' + (SM+1) + '月' + SD + '日<br>星期'+nStr1[SW%7]+'</font>';
		var ldate = '<font style="font-size:9pt;color:violet;" >' + (lDObj.isLeap ? '闰' : ' ') + FormatLunarMonth(lDObj.month) + ' '+ FormatLunarDay(lDObj.day) + '</font>';
		var cdate = '<font style="font-size:9pt;color:violet;" >'+'【'+Animals[(SY-4)%12]+'】'+cyclical(lDObj.yearCyl) + '年 '+cyclical(lDObj.monCyl)+'月 '+cyclical(lDObj.dayCyl)+'日' +'</font>';
		//
		...
		var s1='<table border="1" cellspacing="3" width="130" bordercolor="#000000" bgcolor="#FFFFFF" height="110" cellpadding="2")'+'<tr><td align="center"><b><font color=#008040>'+SY + '年' + (SM+1) + '月' +'</font><br><font face="Arial" size="6" color=#FF8040>'+ SD + '日'+'</font><br><font color=#008040><span style="FONT-SIZE: 10.5pt">'+'星期'+nStr1[SW%7]+'</span></font>'+'<br><font color=#9B4E00>'+ (lDObj.isLeap ? '闰' : ' ') + FormatLunarMonth(lDObj.month) + ' '+ FormatLunarDay(lDObj.day) +'</font></b>'+ festival +'</td></tr></table>';
		return(s1);
	}
